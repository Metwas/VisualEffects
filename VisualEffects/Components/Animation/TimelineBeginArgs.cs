...
namespace VisualEffects.Components.Animation
{
	...
	public class TimelineBeginArgs : EventArgs
	{
		...
		public TimelineBeginArgs(int frameRate, double duration, TimeSpan elapsedTime)
		{
		...
		public TimelineBeginArgs(int frameRate, double duration, double elapsedMilliseconds)
