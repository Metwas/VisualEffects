...
namespace VisualEffects.Components.Animation
{
	...
	public sealed class DoubleAnimation : StructAnimationBase<double>
	{
		...
		{
			args.CurrentValue = this.Current = System.Math.Round(System.Math.Abs((this.To.Value - this.From.Value) * this.EasingFunction.Ease(args.CurrentTime, this.Duration)), this.Precision).Clamp(this.From.Value, this.To.Value);
		}
